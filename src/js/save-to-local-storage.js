(function ($) {
  $.fn.saveToLocalStorage = function (options) {
    ...
    return this.each(function () {
      ...
      $.getJSON('https://api.myjson.com/bins/5a7kb', (json) => {
        $.each(json.posts, (index) => {
          const currentPostHeading = json.posts[index][0];
          const currentPostText = json.posts[index][1];
      ...
      $submit.on('click', (e) => {
        const headingValue = $heading.val();
